...
────────────────────────────────────────────────────────────────────────────
_C:\Users\Amit.Shah\AppData\Roaming\npm\node_modules\learnyounode\exercise
s\make_it_modular\solution\solution.js_ :
...
────────────────────────────────────────────────────────────────────────────
_C:\Users\Amit.Shah\AppData\Roaming\npm\node_modules\learnyounode\exercise
s\make_it_modular\solution\solution_filter.js_ :
...
var mod = require("./ex6module.js");

var dirPath = process.argv[2] || null;
var ext = process.argv[3] || null;

mod(dirPath, ext, getFilteredList);

function getFilteredList(err, arrList) {
    try {

        if (err) throw err;

        arrList.forEach(function(file, i, arr) {
            console.log(arr);
        });
